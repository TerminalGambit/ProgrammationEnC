...
/* Ecrire une fonction lire_flottant sur le modèle de lire_entier. 
Un flottant est de la forme :
(a) un signe "-" (facultatif)
(b) uen suite d'entiers représentant la partie entière. (si vide, la partie entière vaut 0).
(c) un point suivie éventuellement d'une suite d'entiers représentant la partie décimale.
A partir du moment où l'expression contient un point, la partie entière est facultative et vaut alors 0.
*/
