...
/* Ecrire une fonction void affiche_tableau(int tab[], int n) qui affiche les n premiers éléments d'un tableau tab d'entiers 
(n devant être inférieur à la taille du tableau). Ecrire une fonction question1 pour tester votre fonction. */
